...
const PROJECTS = [
  {
    ...
    link: "https://github.com/OgabekHub/faxr-mebel",
  },
  {
    ...
    link: "https://iq-testing-platform.vercel.app",
  },
  {
    ...
    link: "https://github.com/OgabekHub/global-sound",
  },
];
        ...
        {PROJECTS.map((p, idx) => (
          <FadeIn key={p.title} delay={idx * 0.1}>
            <a
              ...
              aria-label={`${p.title} loyihasini ko'rish`}
            ...
            >
              <div className="flex items-center justify-between mb-2">
                ...
                <span className="text-muted transition-colors group-hover:text-purple" aria-hidden="true">
