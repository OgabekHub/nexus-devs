      ...
      <div className="grid gap-5 md:grid-cols-3">
        {FOCUS_AREAS.map((s, idx) => (
          <FadeIn key={s.title} delay={idx * 0.15}>
            ...
            >
              <div className="mb-[18px] flex h-9 w-9 items-center justify-center rounded-lg bg-[--purple-soft] text-purple transition-transform duration-200 ease-out group-hover:scale-110 group-hover:bg-purple group-hover:text-card">
                ◆
              </div>
